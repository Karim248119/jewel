...
export const toTop = {
  ...
  exit: { y: "-80%", opacity: 0 },
  transition: { duration: 1, ease: "easeInOut", damping: 20, type: "spring" },
};
...
//   initial: { y: "80%", x: "-10%", opacity: 0 },
//   animate: { y: 0, x: 0, opacity: 1 },
//   exit: { y: "-80%", x: "0%", opacity: 0 },
//   transition: { duration: 0.3, ease: "easeInOut", damping: 20, type: "spring" },
// };
